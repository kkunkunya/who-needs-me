...
| Tray Icon | 独立 surface | 常驻表达聚合状态 | `micro cat glyph` | calm / working / attention 三张静态状态图 | calm / working / attention @1x/@2x |
...
- Cat character sheet、layered SVG master、Tray 实机截图与 motion note 未经人审前，不得把临时 raster 概念图当运行时资产。
...
| Cat asset family | micro / compact / illustration | state sheet + start/end frames | approved character sheet / SVG masters | `artifacts/design-qa/cat-assets/` |
